...
static int global_count=0,speed_ground=15,speed_cloud=3;//越大越快
...
#define GRAVITY (float )0.05//跳跃管理
static float jump_y=415,jump_speed=7,jump_height=180;
static int if_jump=0,if_down=0,if_jump_up=0;
...
static SDL_Rect over_rect[2]={{290,250,420,85},{474,380,76,43}};
